...
public class LargeFileListAdapter extends RecyclerView.Adapter<LargeFileListAdapter.LargeFileViewHolder> {
    ...
    static class LargeFileViewHolder extends RecyclerView.ViewHolder {
        ...
        LargeFileViewHolder(View view) {
            super(view);
            fileIconImgVw = (ImageView) view.findViewById(R.id.lyt_large_file_largestFile_imgVw_id);
            fileNameTxtVw = (TextView) view.findViewById(R.id.lyt_large_file_fileName_txtVw_id);
            filePathTxtVw = (TextView) view.findViewById(R.id.lyt_large_file_filePath_txtVw_id);
            fileSizeTxtVw = (TextView) view.findViewById(R.id.lyt_large_file_fileSize_txtVw_id);
        }
    }
