...
public class ScanResultTest {
    ...
    public void testNoArgConstructor() {
        ...
        assertEquals(Collections.emptyList(), scanResult.getLargestFiles());
    ...
    public void testAddWhenMultipleFilesAdded() {
        ...
        assertEquals(2, scanResult.getLargestFiles().size());
        assertEquals(2, scanResult.getMostFrequentFileTypes().size());

        assertTrue(scanResult.getLargestFiles().contains(new FileStat("/sdcard/emulated/0/pqr.per", 81)));
        assertTrue(scanResult.getLargestFiles().contains(new FileStat("/sdcard/emulated/0/howdy.txt", 77)));

        System.out.println(scanResult.getLargestFiles());
        System.out.println(scanResult.getMostFrequentFileTypes());
